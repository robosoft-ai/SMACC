...
if __name__ == "__main__":
    ...
    parser.add_argument('-ros_version', help="The version of ros, ie: kinetic", default="kinetic", type=str)
    parser.add_argument('-ubuntu_version', help="The version of ros, ie: xenial", default="xenial", type=str)
    ...
    smacc_viewer_debians = create_and_push_smacc_viewer_debians(osname, osversion, ros_version)

...
// ORTHOGONALS
#include <sm_test2/orthogonals/or_timer.h>
...
//STATE_MACHINE
struct SmTest2
    : public smacc::SmaccStateMachineBase<SmTest2, State1>
{
...
#include <sm_test2/states/st_state_1.h>
#include <sm_test2/states/st_state_2.h>
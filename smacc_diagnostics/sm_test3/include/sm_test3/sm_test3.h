...
// ORTHOGONALS
#include <sm_test3/orthogonals/or_timer.h>
...
//STATE_MACHINE
struct SmTest3
    : public smacc::SmaccStateMachineBase<SmTest3, State1>
{
...
#include <sm_test3/states/st_state_1.h>
#include <sm_test3/states/st_state_2.h>
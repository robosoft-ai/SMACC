...
// ORTHOGONALS
#include <sm_test1/orthogonals/or_timer.h>
...
//STATE_MACHINE
struct SmTest1
    : public smacc::SmaccStateMachineBase<SmTest1, State1>
{
...
#include <sm_test1/states/st_state_1.h>
#include <sm_test1/states/st_state_2.h>
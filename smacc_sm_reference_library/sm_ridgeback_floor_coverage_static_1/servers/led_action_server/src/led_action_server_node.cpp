...
#include <sm_ridgeback_floor_coverage_static_1/LEDControlActionResult.h>
#include <sm_ridgeback_floor_coverage_static_1/LEDControlResult.h>
#include <memory>
#include <visualization_msgs/MarkerArray.h>

typedef actionlib::SimpleActionServer<sm_ridgeback_floor_coverage_static_1::LEDControlAction> Server;
...
public:
  ...
  sm_ridgeback_floor_coverage_static_1::LEDControlGoal cmd;
...
*/
  LEDActionServer()
  {
    currentState_ =  sm_ridgeback_floor_coverage_static_1::LEDControlResult::STATE_UNKNOWN;
  }
...
{
    sm_ridgeback_floor_coverage_static_1::LEDControlFeedback feedback_msg;
...
******************************************************************************************************************
*/
void execute(const sm_ridgeback_floor_coverage_static_1::LEDControlGoalConstPtr& goal)  // Note: "Action" is not appended to DoDishes here
{
  ROS_INFO_STREAM("Tool action server request: "<< *goal);
  cmd = *goal;

  if(goal->command == sm_ridgeback_floor_coverage_static_1::LEDControlGoal::CMD_ON)
  {
    currentState_ =  sm_ridgeback_floor_coverage_static_1::LEDControlResult::STATE_RUNNING;
  }
  else  if (goal->command == sm_ridgeback_floor_coverage_static_1::LEDControlGoal::CMD_OFF)
  {
    currentState_ =  sm_ridgeback_floor_coverage_static_1::LEDControlResult::STATE_IDLE;
  }
...
void publishStateMarker()
{
    ...
    if(currentState_ == sm_ridgeback_floor_coverage_static_1::LEDControlResult::STATE_RUNNING)
    {
      // show green ball
      marker.color.r = 0;
      marker.color.g = 1;
    ...
    else if (currentState_ == sm_ridgeback_floor_coverage_static_1::LEDControlResult::STATE_IDLE)
    {
      // show gray ball
      marker.color.r = 0.7;
      marker.color.g = 0.7;

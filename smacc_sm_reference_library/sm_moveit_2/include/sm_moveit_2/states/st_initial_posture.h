...
{
// STATE DECLARATION
struct StInitialPosture : smacc::SmaccState<StInitialPosture, SmMoveit2>
{
    ...
    std::map<std::string, double> jointValues
       {{"torso_lift_joint", 0.05},
        ...
        configure_orthogonal<OrNavigation, CbMoveKnownState>("sm_moveit_2", "config/manipulation/known_states/initial_posture.yaml");
    }

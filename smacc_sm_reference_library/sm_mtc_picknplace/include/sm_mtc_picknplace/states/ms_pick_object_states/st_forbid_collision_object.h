...
// TRANSITION TABLE
    ...
    Transition<EvKeyPressN<CbDefaultKeyboardBehavior, OrKeyboard>, StMoveToPlace, PREEMPT>,
    Transition<EvTimer<CbTimerCountdownOnce, OrTimer>, StMoveToPlace, SUCCESS>

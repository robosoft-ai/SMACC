...
using namespace sm_moveit_3::pick_states;

// STATE DECLARATION
struct SsPickObject : smacc::SmaccState<SsPickObject, SmMoveit3, StMovePregraspPose>
{
public:
...
#include <sm_moveit_3/states/pick_states/st_close_gripper.h>
#include <sm_moveit_3/states/pick_states/st_grasp_approach.h>
#include <sm_moveit_3/states/pick_states/st_grasp_retreat.h>
#include <sm_moveit_3/states/pick_states/st_move_pregrasp_pose.h>
#include <sm_moveit_3/states/pick_states/st_navigation_posture.h>

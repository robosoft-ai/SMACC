...
{
    // STATE DECLARATION
    struct StInitialPosture : smacc::SmaccState<StInitialPosture, SmMoveitWineFetch>
    {
        ...
        typedef mpl::list<
            ...
            Transition<EvCbSuccess<CbMoveEndEffector, OrArm>, StNavigateToSourceTable/*StPouringPosture*/, SUCCESS>>
            reactions;

        // STATE FUNCTIONS
        static void staticConfigure()
        {
            //configure_orthogonal<OrArm, CbMoveKnownState>("sm_moveit_wine_serve", "config/manipulation/known_states/initial_posture.yaml");

...
{
    // STATE DECLARATION
    struct StPouringPosture : smacc::SmaccState<StPouringPosture, SmFetchSixTablePickNSort1>
    {
        ...
        static void staticConfigure()
        {
            ...
            configure_orthogonal<OrArm, CbCircularPouringMotion>(pivot, -0.2, "gripper_link", "map");

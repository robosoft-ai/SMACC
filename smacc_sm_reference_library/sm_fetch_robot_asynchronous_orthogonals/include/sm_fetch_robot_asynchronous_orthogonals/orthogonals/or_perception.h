...
#include <sm_fetch_robot_asynchronous_orthogonals/clients/perception_system_client/cl_perception_system.h>

using namespace sm_fetch_robot_asynchronous_orthogonals::cl_perception_system;

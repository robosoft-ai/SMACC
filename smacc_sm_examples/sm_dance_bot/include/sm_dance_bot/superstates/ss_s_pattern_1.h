...
public:
    ...
    typedef mpl::list<
        // Expected event
        smacc::transition<EvLoopEnd<SsrSPatternLoopEnd>, StRotateDegrees6, ENDLOOP >,
...
#include <sm_dance_bot/superstate_routines/s_pattern/ssr_spattern_loop_end.h>

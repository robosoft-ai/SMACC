/**
 * @file JointControlActualFsmSeriesElastic.cpp
 */

#include "nasa_robodyn_mechanisms_core/JointControlActualFsmSeriesElastic.h"
/***************************************************************************//**
 *
 * @brief Constructor for JointControlActualFsmSeriesElastic
 *
 ******************************************************************************/
JointControlActualFsmSeriesElastic::JointControlActualFsmSeriesElastic(const std::string& mechanism, IoFunctions ioFunctions, NodeRegisterManagerPtr nodeRegisterManager)
    : JointControlActualFsmInterface(mechanism, ioFunctions), nodeRegisterManager(nodeRegisterManager)
{
    setParameters();
}

JointControlActualFsmSeriesElastic::~JointControlActualFsmSeriesElastic()
{
    // Nothing
}
void JointControlActualFsmSeriesElastic::setParameters()
{
    ...
    if (!loadOkay)
    {
        ...
        RCS::Logger::log("gov.nasa.JointControlActualFsmSeriesElastic", log4cpp::Priority::FATAL, err.str());
        throw std::runtime_error(err.str());
    }
    TiXmlHandle doc(&file);
    RCS::Logger::log("gov.nasa.JointControlActualFsmSeriesElastic", log4cpp::Priority::INFO, "File [" + parameterFile + "] successfully loaded.");
    ...
    else
    {
        ...
        RCS::Logger::log("gov.nasa.JointControlActualFsmSeriesElastic", log4cpp::Priority::ERROR, err.str());
        throw std::runtime_error(err.str());
    }
}
 ...
 *
 ******************************************************************************/
nasa_r2_common_msgs::JointControlData JointControlActualFsmSeriesElastic::getStates(void)
{
 ...
 *
 ******************************************************************************/
void JointControlActualFsmSeriesElastic::updateControlModeState(void)
{
    ...
    if(nodeRegisterManager->getStatusValue(mechanism, ProcAliveStatusName)   == 0)
    {
        ...
        {
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::INFO << mechanism << ": FAULT DETECTED: " << ProcAliveStatusName << " == 0";
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlMode::FAULTED on joint: " << mechanism;
    ...
    if(nodeRegisterManager->getStatusValue(mechanism, CommAliveStatusName)   == 0)
    {
        if(states.controlMode.state != nasa_r2_common_msgs::JointControlMode::FAULTED)
        {
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::INFO << mechanism << ": FAULT DETECTED: " << CommAliveStatusName << " == 0";
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlMode::FAULTED on joint: " << mechanism;
            states.controlMode.state = nasa_r2_common_msgs::JointControlMode::FAULTED;
        }
        return;
    ...
    if(nodeRegisterManager->getControlValue(mechanism, BootEnableControlName) == 0)
    {
        ...
        {
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlMode::BOOTLOADER on joint: " << mechanism;
    ...
    if(nodeRegisterManager->getStatusValue(mechanism, BridgeEnableStatusName) == 0)
    {
            ...
            (currentBrakeRelease == 0) )
        {
            ...
            {
                RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlMode::OFF on joint: " << mechanism;
        ...
        else
        {
            ...
            {
                RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::ERROR << mechanism << ": INVALID CONTROL MODE STATE DETECTED, BridgeEnable == 0, and MotorEnable or BrakeRelease == 1";
                RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlMode::INVALID on joint: " << mechanism;
    ...
    if(nodeRegisterManager->getStatusValue(mechanism, JointFaultStatusName) == 1)
    {
        if(states.controlMode.state != nasa_r2_common_msgs::JointControlMode::FAULTED)
        {
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::INFO << mechanism << ": FAULT DETECTED";
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlMode::FAULTED on joint: " << mechanism;
            states.controlMode.state = nasa_r2_common_msgs::JointControlMode::FAULTED;
        }
        return;
        ...
        (currentBrakeRelease == 0) )
    {
        ...
        {
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlMode::PARK on joint: " << mechanism;
        ...
        (currentBrakeRelease == 1) )
    {
        ...
        {
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlMode::NEUTRAL on joint: " << mechanism;
        ...
        (currentBrakeRelease == 1) )
    {
        ...
        {
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlMode::DRIVE on joint: " << mechanism;
    ...
    if(states.controlMode.state != nasa_r2_common_msgs::JointControlMode::INVALID)
    {
        RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::INFO << mechanism << ": INVALID CONTROL MODE STATE DETECTED";
        RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlMode::INVALID on joint: " << mechanism;
        states.controlMode.state = nasa_r2_common_msgs::JointControlMode::INVALID;
    }
}
 ...
 *
 ******************************************************************************/
void JointControlActualFsmSeriesElastic::updateCommandModeState(void)
{
    // Check for MOTCOM
    if(nodeRegisterManager->getStatusValue(mechanism, MotComSourceStatusName) == 0)
    {
        ...
        {
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlCommandMode::MOTCOM on joint: " << mechanism;
        ...
        (currentControlMode    == 1) )
    {
        ...
        {
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlCommandMode::STALLMODE on joint: " << mechanism;
        ...
        (currentPosComVelocity == 0) )
    {
        ...
        {
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlCommandMode::MULTILOOPSTEP on joint: " << mechanism;
            states.commandMode.state = nasa_r2_common_msgs::JointControlCommandMode::MULTILOOPSTEP;
        }
        return;
    }
    ...
    {
        if(states.commandMode.state != nasa_r2_common_msgs::JointControlCommandMode::MULTILOOPSMOOTH)
        {
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlCommandMode::MULTILOOPSMOOTH on joint: " << mechanism;
            states.commandMode.state = nasa_r2_common_msgs::JointControlCommandMode::MULTILOOPSMOOTH;
        }
        return;
    }
    ...
    {
        RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::INFO << mechanism << ": INVALID COMMAND MODE STATE DETECTED";
        RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlCommandMode::INVALID on joint: " << mechanism;
 ...
 *
 ******************************************************************************/
void JointControlActualFsmSeriesElastic::updateCalibrationModeState(void)
{
    // Check for DISABLE
    if(nodeRegisterManager->getStatusValue(mechanism, CalibrationModeStatusName) == 0)
    {
        ...
        {
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlCalibrationMode::DISABLE on joint: " << mechanism;
    ...
    {
        RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlCalibrationMode::ENABLE on joint: " << mechanism;
 ...
 *
 ******************************************************************************/
void JointControlActualFsmSeriesElastic::updateClearFaultModeState(void)
{
    // Check for DISABLE
    if(nodeRegisterManager->getStatusValue(mechanism, ClearFaultStatusName) == 0)
    {
        ...
        {
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlClearFaultMode::DISABLE on joint: " << mechanism;
    ...
    {
        RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlClearFaultMode::ENABLE on joint: " << mechanism;
 ...
 *
 ******************************************************************************/
void JointControlActualFsmSeriesElastic::updateCoeffState(void)
{
    // Check for NOTLOADED
    if(nodeRegisterManager->getStatusValue(mechanism, CoeffsLoadedStatusName) == 0)
    {
        ...
        {
            RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlCoeffState::NOTLOADED on joint: " << mechanism;
    ...
    {
        RCS::Logger::getCategory("gov.nasa.JointControlActualFsmSeriesElastic") << log4cpp::Priority::DEBUG << "Transition to JointControlCoeffState::LOADED on joint: " << mechanism;
